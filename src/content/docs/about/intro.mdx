...
**Encounter+ is the app you run your tabletop games from.** It keeps your creatures, spells, items
and notes in one library, builds encounters out of them, tracks initiative while you play, and puts
a battle map on the table — with a second, player-facing view for the people sitting across from
you.
...
- Want the mental model first? [How it works](/guides/how-it-works/) explains the core concepts
  behind the app in a few minutes.
